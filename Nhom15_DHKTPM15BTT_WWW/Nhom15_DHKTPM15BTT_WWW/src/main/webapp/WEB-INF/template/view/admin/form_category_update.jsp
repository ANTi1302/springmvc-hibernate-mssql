	...
	<div class="container-scroller d-flex">
		...
		<div>
			...
			<div class="main-panel">
				<div class="row">
					<div class="card-body">
						<h4 class="card-title">Category form update</h4>
						<form:form class="forms-sample" action="saveCategory"
							...
							<div class="form-group">
								...
								<div class="input-group col-xs-12">
									<input type="text" class="form-control file-upload-info"
										...
										<button style="background-color: #223E9C"
											class="file-upload-browse btn btn-primary" type="button">Upload</button>
									</span>
								</div>
							</div>
							...
							<button class="btn btn-light"
								onclick="window.location.href='${pageContext.request.contextPath}/admin/category/1&'; return false;">Cancel</button>
						</form:form>
					</div>
				</div>
			</div>
