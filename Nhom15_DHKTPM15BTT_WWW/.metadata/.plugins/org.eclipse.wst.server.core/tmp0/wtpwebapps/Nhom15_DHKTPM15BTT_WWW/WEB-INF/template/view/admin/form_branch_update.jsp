                    ...
                    <div class="form-horizontal" id="frm-crcust">
                        <div class="col-md-6 col-xs-12 padd-0" style="margin-top: 18px;">
                            ...
                            <div class="col-md-9 col-xs-7 padd-0">
                                <input type="text" id="customer_Title" name="customer_Title" class="form-control" value=""
                                       placeholder="Nhập tên nhà cung cấp">
                                <span style="color: red; font-style: italic;" class="error error-customer_Title"></span>
                            </div>
                        </div>
                        <div class="col-md-6 col-xs-12 padd-0" style="margin-top: 18px;">
                          <div class="col-md-6">
                        ...
                        <div class="col-md-6 col-xs-12 padd-0" style="margin-top: 18px;">
                            ...
                            <div class="col-md-9 col-xs-7 padd-0">
                                    <textarea name=""id="customer_Description" name="customer_Description"
                                    class="form-control" cols="70" rows="10"></textarea>   
                                <span style="color: red; font-style: italic;" class="error error-customer_Description"></span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary me-2" onclick="window.location.href='${pageContext.request.contextPath}/admin/branch/1&'; return false;"><i
                                class="fa fa-check"></i> Update
                    </button>
                    <button type="button" class="btn btn-light" data-dismiss="modal" onclick="window.location.href='${pageContext.request.contextPath}/admin/branch/1&'; return false;"><i
