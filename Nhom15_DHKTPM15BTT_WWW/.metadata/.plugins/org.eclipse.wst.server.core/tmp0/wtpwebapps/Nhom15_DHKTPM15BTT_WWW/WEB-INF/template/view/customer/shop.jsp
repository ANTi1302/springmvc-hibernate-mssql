        ...
        <div class="shop_sidebar_area">
            ...
            <div class="widget brands mb-50">
                ...
                <div class="form-check">
                        ...
                        <label class="form-check-label"  for="${branchs.title }"><a style=" font-size: 15px; color: #95969A" class="form-check-label"  href="branch?txtC=${branchs.branchId}">${branchs.title } </a> </label>
                    </div>
                </c:forEach>
                </div>
            </div>
