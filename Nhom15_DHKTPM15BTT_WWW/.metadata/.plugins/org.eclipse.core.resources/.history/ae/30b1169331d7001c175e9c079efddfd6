        ...
        <div class="row">
          <div class="card-body">
            ...
            <form class="forms-sample">
              ...
              <button style="background-color: #223E9C" type="submit" class="btn btn-primary me-2" onclick="window.location.href='${pageContext.request.contextPath}/admin/category/1&'; return false;">Update</button>
