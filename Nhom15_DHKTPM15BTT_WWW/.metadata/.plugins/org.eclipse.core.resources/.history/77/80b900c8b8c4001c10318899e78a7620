	...
	<div class="header_top">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-11">
					<ul>
						<img src="<c:url value="/assets/img/bg-img/hinhdemo.png" /> "
							width="100%" alt="">
						<ul>
				</div>
				<div class="">
					<ul>
						<div class="social-icons pull-right">
							...
							<ul class="nav navbar-nav">
								<li><a href="#"><img
										src="<c:url value="/assets/img/logo_contact/fb.png" /> "></a></li>
								<li><a href="#"><img
										src="<c:url value="/assets/img/logo_contact/tw.png" /> "></a></li>
								<li><a href="#"><img
										src="<c:url value="/assets/img/logo_contact/in.png" /> "></a></li>
								<li><a href="#"><img
										src="<c:url value="/assets/img/logo_contact/dr.png" /> "></a></li>
								<li><a href="#"><img
										src="<c:url value="/assets/img/logo_contact/gg.png" /> "></a></li>
							</ul>
