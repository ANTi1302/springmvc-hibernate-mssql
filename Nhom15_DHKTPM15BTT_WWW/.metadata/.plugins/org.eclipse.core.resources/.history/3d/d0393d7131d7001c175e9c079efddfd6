            ...
            <div class="card-body">
              ...
              <div class="table-responsive">
                ...
                <input type="button" value="Add Category"
                  ...
                  <tr>
                      <td>${o.name }</td>
                      <td><button class="badge badge-warning"  onclick="window.location.href='${pageContext.request.contextPath}/admin/updatecategory'; return false;" >Edit</button>
...
<!-- base:js -->
  ...
  <script src="<c:url value="/assets/assets-admin/js/dashboard.js" />"></script>
    <script src="<c:url value="/assets/assets-admin/vendors/js/bootstrap.bundle.min.js.map" />"></script>
